...
To be able to delivery the full mobile application experience, the app has to be native.
This will change, when all of the phones hardware interface is exposed to the web browser.
...
In this way, an web app can in fact use restricted components like push notifications and beacons.
