...
This is also true for the legacy implementation, which lacks a few features but is implementing it's requirements, too.
...
If the requirements are valid for every platform\footnote{iOS, Android}, also the different platform interpreter evaluations can be compared to each other.
